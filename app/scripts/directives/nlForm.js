'use strict';
var nlForm = angular.module('nlForm', ['ngSanitize']);
nlForm.directive('nlSelect', function() {
    return {
      ...
      template: "<div ng-form='nlSelect' class='nl-field nl-dd' ng-class=\"{'nl-field-open': opened}\">" +
...
nlForm.directive('nlText', function() {
    return {
      ...
      template: '<div ng-form class="nl-field nl-ti-text" ng-class="{\'nl-field-open\': opened}">' +
        ...
        '</li>' +
        '<li class="nl-ti-example" ng-show="showSubline()" ng-bind-html="subline"></li>' +
        '</ul>' +
        '</div>',
